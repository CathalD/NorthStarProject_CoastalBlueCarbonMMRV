...
if (crediting_ready) {
  recommendations$crediting <- "✓ CREDITING READY: Project meets all technical requirements for carbon crediting"
} else {
...
<h1>🌍 Comprehensive Standards Compliance Report</h1>
...
cat("\nOutputs:\n")
cat("  📄 HTML Report: outputs/mmrv_reports/comprehensive_standards_report.html\n")
cat("  📊 Compliance Summary: outputs/mmrv_reports/standards_compliance_summary.csv\n")
cat("  📋 Action Plan: outputs/mmrv_reports/recommendations_action_plan.csv\n")
cat("  💡 Recommendations: outputs/mmrv_reports/project_recommendations.rds\n")
